...
namespace DamConsultants\Avery\Helper;
...
class Data extends AbstractHelper
{
    ...
    public function getLoadCredential()
    {
        ...
        if (!empty($this->bynderDomain) && !empty($this->permanent_token) && !empty($this->by_redirecturl)) {
            ...
            return "Averyauthentication failed | Please check your credential";
        }
    }
    /**
     * Get Redirecturl
    ...
    /**
     * Change Popup AveryAssets Details
     *
     * @param array $bynder_auth
     * @return $this
     */
