...
use DamConsultants\Avery\Model\ResourceModel\Collection\BynderAutoReplaceDataCollectionFactory;
...
class MassDeleteCronAutoData extends Action
{
     ...
     * @param \DamConsultants\Avery\Model\BynderAutoReplaceDataFactory $bynderFactory
     */
    public function __construct(
        Context $context,
        Filter $filter,
        BynderAutoReplaceDataCollectionFactory $collectionFactory,
        \DamConsultants\Avery\Model\BynderAutoReplaceDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
    ...
    {
        return $this->_authorization->isAllowed('DamConsultants_Avery::delete');
    }
}
